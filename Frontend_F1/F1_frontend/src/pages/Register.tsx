...
import type {RegisterRequest}  from '../components/type_files'; // interface dosyanın yolu
      ...
      <div className="bg-zinc-900 p-8 rounded-xl border-l-4 border-red-600 shadow-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
           ...
           <div>
            <label className="text-zinc-400 text-sm uppercase">Şifre Onaylama</label>
            <input 
          ...
          <button className="w-full bg-white hover:bg-blue-400 text-black font-bold py-3 px-4 rounded transition-all mt-4 flex items-center justify-center">
            <img src={`/src/assets/bayrak.png`} alt="f1" className="h-10 w-auto object-contain"/>
            
            <span className="uppercase tracking-widest">  KAYIT OL  </span>
